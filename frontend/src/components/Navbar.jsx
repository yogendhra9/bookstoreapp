  ...
  function Navbar() {
    ...
    return (
      <>
        <div
          className={` max-w-screen-2xl container mx-auto  md:px-16 px-4 fixed top-0 right-0 left-0 z-50
          ${
            sticky
          ...
          <div className="navbar">
            ...
            <div className="navbar-end space-x-3">
              ...
              {authUser ? (
                ...
                <div>
                  <a
                    className=" px-3 py-2 btn bg-secondary text-black rounded-md hover:bg-primary duration:3400 cursor-pointer"
                    onClick={() =>
